...
// Where the Oil Boards PDF lives in Supabase Storage (PRIVATE bucket — the file
...
export const OIL_BOARDS_FILENAME = "Food-Pharmer-Oil-Boards.pdf";
...
// Emails the Oil Boards PDF as an attachment. Throws on a genuine send failure
...
export async function sendOilBoardsEmail(to: string): Promise<{ ok: true } | { ok: false; reason: "no_pdf" }> {
  ...
  await transport().sendMail({
    ...
    to,
    subject: "Your Oil Boards from Food Pharmer",
    text: [
      "Hi,",
      "",
      "Thanks for requesting the Oil Boards. The PDF is attached to this email.",
      "",
    ...
    html: `
      <div style="font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:1.6;color:#1a1a1a;max-width:520px;margin:0 auto">
        <p>Hi,</p>
        <p>Thanks for requesting the <strong>Oil Boards</strong>. The PDF is attached to this email.</p>
        <p style="margin-top:28px;font-size:13px;color:#666">
          Better for You by Food Pharmer<br>
          <a href="https://foodpharmer.health" style="color:#666">foodpharmer.health</a>
        </p>
      </div>`,
    attachments: [
